...
CROP_CATALOG = [
    ...
    {"id": "chilli", "name_en": "Green Chilli & Capsicum", "name_hi": "हरी मिर्च व शिमला मिर्च", "season": "RABI", "icon": "🌶️"},
    {"id": "apple", "name_en": "Apple Orchard", "name_hi": "सेब बागवानी", "season": "RABI", "icon": "🍎"},
    ...
    {"id": "cucumber", "name_en": "Cucumber & Gourd", "name_hi": "खीरा व लौकी", "season": "ZAID", "icon": "🥒"},
    {"id": "vegetables", "name_en": "Mixed Vegetables", "name_hi": "मिश्रित सब्जियां", "season": "ZAID", "icon": "🥬"},
    {"id": "fodder", "name_en": "Fodder Crops", "name_hi": "चारा फसलें", "season": "ZAID", "icon": "🌿"},
]
...
def compute_crop_stage_advisory(
    ...
    pest_notes = {
        ...
        "basmati": ("Monitor for Bacterial Leaf Blight (Xanthomonas) and Stem Rot under prolonged cloudiness.", "लगातार बादल छाए रहने पर जीवाणु पत्ती झुलसा (BLB) और तना सड़न रोग पर नज़र रखें।"),
        ...
        "ragi": ("Check for Blast (Pyricularia grisea) and Stem Borer in damp weather.", "नम मौसम में झुलसा रोग (ब्लास्ट) और तना छेदक की रोकथाम करें।"),
        ...
        "turmeric": ("Watch for Rhizome Rot and Leaf Spot. Maintain ridge drainage in wet weather.", "प्रकंद सड़न (राइजोम रॉट) और पर्ण धब्बा रोग से बचाव के लिए मेड़ों पर जल निकासी रखें।"),
        "ginger": ("Inspect for Soft Rot (Pythium) and Bacterial Wilt. Avoid water stagnation.", "मृदु सड़न (सॉफ्ट रॉट) व जीवाणु उकठा रोग की रोकथाम करें। जल जमाव बिल्कुल न होने दें।"),
        "sesame": ("Check for Phyllody and Antigastra leaf and pod caterpillar.", "फाइलोडी (बांझपन) और पत्ती व फली छेदक सुंडी की नियमित जांच करें।"),
        "mango": ("Monitor Hopper and Powdery Mildew during flowering; apply neem-based sprays.", "मंजर खिलने के समय भुनगा (हॉपर) और दहिया रोग की रोकथाम हेतु नीम युक्त स्प्रे करें।"),
        "banana": ("Inspect for Panama Wilt and Sigatoka Leaf Spot. Ensure clean suckers.", "पनामा विल्ट और सिगाटोका पत्ती धब्बा रोग पर नज़र रखें। स्वस्थ पुत्तियों का ही चयन करें।"),
        "tea": ("Scout for Tea Mosquito Bug and Red Spider Mite during dry spells.", "चाय मच्छर कीट (हेलोपेल्टिस) और लाल मकड़ी कीट पर सतर्क नज़र रखें।"),
        "coffee": ("Check for Coffee Berry Borer (Hypothenemus hampei) and Leaf Rust.", "कॉफ़ी बेरी बोरर और पत्ती रतुआ (हेमिलिया) से बचाव के उपाय करें।"),
        "coconut": ("Monitor Rhinoceros Beetle and Bud Rot in crown canopy.", "गैंडा भृंग (राइनोसेरोस बीटल) और कली सड़न रोग से नारियल के पेड़ों की रक्षा करें।"),
        "rubber": ("Watch for Abnormal Leaf Fall and Corynespora Leaf Disease in monsoon.", "मानसून में पत्तियों के असामान्य झड़ने और कोरीनेस्पोरा रोग की रोकथाम करें।"),
        ...
        "lentil": ("Monitor Rust and Stemphylium Blight in cool foggy conditions.", "कोहरे और ठंड में मसूर में रतुआ और स्टेमफिलियम झुलसा रोग की जांच करें।"),
        ...
        "tomato": ("Inspect for Early/Late Blight and Fruit Borer (Helicoverpa).", "अगेती/पछेती झुलसा और फल छेदक कीट की रोकथाम करें।"),
        "chilli": ("Monitor for Chilli Thrips (Scirtothrips dorsalis), Mites, and Anthracnose fruit rot.", "मिर्च में थ्रिप्स, माइट कीट और फल सड़न (एंथ्रेक्नोज) पर विशेष निगरानी रखें।"),
        "apple": ("Watch for Apple Scab and Woolly Apple Aphid during cool foggy weather.", "शीत व कोहरे के मौसम में सेब स्कैब और वूली एफिड कीट की रोकथाम करें।"),
        ...
        "cucumber": ("Check for Powdery Mildew and Downy Mildew on leaf surfaces. Spray neem oil preventive.", "पत्तियों पर चूर्णिल आसिता (पाउडरी मिल्ड्यू) की रोकथाम हेतु नीम तेल का छिड़काव करें।"),
...
CROP_DB = [
    ...
    {"name_en": "Basmati Rice", "name_hi": "बासमती चावल", "season": "KHARIF", "icon": "🌾",
     "temp_min": 20, "temp_max": 32, "rain_season_mm": 1100, "rain_daily_mm": 12,
     "hum_min": 65, "hum_max": 88, "soil_min": 0.28, "duration": 135,
     "sow_months": [6, 7], "market_inr": 3850},
    ...
    {"name_en": "Turmeric", "name_hi": "हल्दी", "season": "KHARIF", "icon": "🫚",
     "temp_min": 20, "temp_max": 35, "rain_season_mm": 1200, "rain_daily_mm": 10,
     "hum_min": 65, "hum_max": 90, "soil_min": 0.26, "duration": 240,
     "sow_months": [5, 6], "market_inr": 8200},
    {"name_en": "Ginger", "name_hi": "अदरक", "season": "KHARIF", "icon": "🫚",
     "temp_min": 19, "temp_max": 32, "rain_season_mm": 1400, "rain_daily_mm": 12,
     "hum_min": 70, "hum_max": 90, "soil_min": 0.28, "duration": 220,
     "sow_months": [4, 5], "market_inr": 7500},
    {"name_en": "Sesame (Til)", "name_hi": "तिल", "season": "KHARIF", "icon": "🌱",
     "temp_min": 22, "temp_max": 36, "rain_season_mm": 450, "rain_daily_mm": 5,
     "hum_min": 45, "hum_max": 70, "soil_min": 0.16, "duration": 90,
     "sow_months": [6, 7], "market_inr": 8600},
    ...
    {"name_en": "Green Chilli & Capsicum", "name_hi": "हरी मिर्च व शिमला मिर्च", "season": "RABI", "icon": "🌶️",
     "temp_min": 16, "temp_max": 32, "rain_season_mm": 450, "rain_daily_mm": 5,
     "hum_min": 45, "hum_max": 75, "soil_min": 0.20, "duration": 130,
     "sow_months": [9, 10, 11], "market_inr": 3200},
    {"name_en": "Apple Orchard", "name_hi": "सेब बागवानी", "season": "RABI", "icon": "🍎",
     "temp_min": 5, "temp_max": 22, "rain_season_mm": 600, "rain_daily_mm": 4,
     "hum_min": 50, "hum_max": 75, "soil_min": 0.25, "duration": 365,
     "sow_months": [1, 2, 11, 12], "market_inr": 7000},
    ...
    {"name_en": "Cucumber & Gourd", "name_hi": "खीरा व लौकी", "season": "ZAID", "icon": "🥒",
     "temp_min": 22, "temp_max": 36, "rain_season_mm": 250, "rain_daily_mm": 4,
     "hum_min": 40, "hum_max": 70, "soil_min": 0.18, "duration": 70,
     "sow_months": [2, 3, 4], "market_inr": 1800},
    {"name_en": "Mixed Vegetables", "name_hi": "मिश्रित सब्जियां", "season": "ZAID", "icon": "🥬",
     "temp_min": 20, "temp_max": 35, "rain_season_mm": 300, "rain_daily_mm": 5,
     "hum_min": 45, "hum_max": 75, "soil_min": 0.20, "duration": 80,
     "sow_months": [2, 3, 4], "market_inr": 2500},
    {"name_en": "Fodder Crops", "name_hi": "चारा फसलें", "season": "ZAID", "icon": "🌿",
     "temp_min": 18, "temp_max": 38, "rain_season_mm": 300, "rain_daily_mm": 5,
     "hum_min": 40, "hum_max": 70, "soil_min": 0.20, "duration": 60,
     "sow_months": [2, 3, 4, 5], "market_inr": 1200},
